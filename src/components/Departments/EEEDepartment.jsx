  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-900 to-gray-700 text-white flex items-center justify-center px-6">
      <div className="container mx-auto text-center py-16">
        <h2 className="text-5xl font-bold mb-4 text-yellow-400">Electrical and Electronics Engineering</h2>
        <p className="text-lg mb-8 max-w-3xl mx-auto">
          Powering the Future with Innovation. The Electrical and Electronics Engineering department at Government Polytechnic College, Vanavasi, focuses on advanced electrical systems, automation, and embedded technologies to shape the engineers of tomorrow.
        </p>
        
        <div className="max-w-4xl mx-auto text-left space-y-10">
          <div>
            <h3 className="text-3xl font-semibold mb-3 text-yellow-300">Key Highlights:</h3>
            <ul className="list-disc ml-6 space-y-2 text-lg">
              <li>Expert training in power systems, control systems, and circuit design.</li>
              <li>Hands-on experience with microcontrollers, PLCs, and IoT technologies.</li>
              <li>Focus on renewable energy solutions and smart grid technologies.</li>
              <li>Opportunities for research in automation, robotics, and power electronics.</li>
              <li>Industry collaborations for real-world exposure and internships.</li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-3xl font-semibold mb-3 text-yellow-300">Career Opportunities:</h3>
            <ul className="list-disc ml-6 space-y-2 text-lg">
              <li>Electrical Design Engineer</li>
              <li>Power Systems Engineer</li>
              <li>Embedded Systems Developer</li>
              <li>Automation and Control Engineer</li>
              <li>Renewable Energy Specialist</li>
              <li>Electronics and Communication Engineer</li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-3xl font-semibold mb-3 text-yellow-300">Facilities and Labs:</h3>
            <ul className="list-disc ml-6 space-y-2 text-lg">
              <li>State-of-the-art laboratories for electrical machines, power electronics, and control systems.</li>
              <li>Advanced microcontroller and embedded systems lab for hands-on learning.</li>
              <li>Simulation labs equipped with MATLAB, Simulink, and AutoCAD Electrical.</li>
              <li>Industry-linked research opportunities in power generation and smart grids.</li>
            </ul>
          </div>
        </div>
